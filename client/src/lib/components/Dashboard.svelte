...
<div class="h-full flex">
  <div class="flex-1 flex flex-col gap-4">
    ...
    <img src={`http://${$ipAddress}:1507/`} alt="" class="w-[700px] h-[540px] aspect-4/3 bg-black rounded-md" />
    <ul class="flex flex-wrap items-center overflow-x-auto gap-4 mt-2 text-mb-text">
      <li>
